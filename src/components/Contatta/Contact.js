    ...
    <div className={styles.contact}>
      ...
      <div className={styles.card}>
        ...
        <p className={styles["info"]}>
          Insegnante di <span className={styles["blue"]}>Matematica</span>,
          Aiuto tesi, Contabilità e bilancio, <br />
      ...
      <div className={styles.price}>
        ...
        <label className={styles["priceperhour"]}>
          <span>20</span>€/ora
        </label>
      ...
      <div className={styles.info}>
        <p>
          9000 ore d'insegnamento tra l'aula e l'on line. Specialista di
          marketing, controllo costi, critica alla globalizzazione. Insegno
          diritto, economia, ge <span>... Scopri di più</span>
        </p>
      </div>
    </div>
  );
